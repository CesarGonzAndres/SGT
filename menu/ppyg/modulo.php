...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" href="#">Informe Modulo de Seguimiento</a>
		</div>
				...
				<table>
					...
					$query= mysql_query("SELECT
						*	
						...
						WHERE
						x104t_diario_ppyg.fe_reporte = '$fecha'", $con);
					while ($fila = mysql_fetch_assoc($query)){
						...
						$va_dias_inactivos_acumulados1=$fila['va_dias_inactivos_acumulados'];
						...
						do{
							...
							<td value="">'.$va_dias_inactivos_acumulados1=$fila['va_dias_inactivos_acumulados'].'</td>
						</tr>';
					}while ($fila = mysql_fetch_assoc($query));
				}
				echo '</tr></table></div>';
